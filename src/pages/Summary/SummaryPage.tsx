...
const MOCK_SUMMARY_DATA = {
  ...
  tips: [
    {
      id: 1,
      title: 'Wi-Fi 우선 사용 권장: ',
      text: '데이터 속도가 불안정한 실내 장소에서는 가급적 Wi-Fi를 우선 연결하여 사용하시는 것을 추천드립니다.',
    },
    {
      id: 2,
      title: '신뢰할 수 있는 AP 활용: ',
      text: '보안이 확인된 신뢰할 수 있는 AP를 연결하면 훨씬 안정적인 통신 환경을 이용하실 수 있습니다',
    },
  ],
};
